...
class RoomViewModel with _$RoomViewModel {
  const factory RoomViewModel({
    ...
    required int price,
    @JsonKey(name: 'price_per') required String priceDescription,
    required List<String> peculiarities,
    required List<String> imageUrls,
    @Default(0) int imageIndex,
  }) = _RoomViewModel;

  factory RoomViewModel.fromJson(Map<String, dynamic> json) =>
      _$RoomViewModelFromJson(json);

  factory RoomViewModel.initial() => const RoomViewModel(
        id: 0,
        name: '',
        price: 0,
        priceDescription: '',
  ...
  factory RoomViewModel.mock1() => const RoomViewModel(
        id: 1,
  ...
  factory RoomViewModel.mock2() => const RoomViewModel(
        id: 2,
